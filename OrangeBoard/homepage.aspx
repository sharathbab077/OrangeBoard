...
<li><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/DiscussionForum.aspx">HyperLink</asp:HyperLink></li>
               </ul>
               <!-- end #nav -->
            </nav>
            <!-- end #nav-wrap -->
         ...
         <section id="resume">
               ...
               <div class="row education">
                  <div class="seven columns header-col">
                      <img src="images/col.jpg" alt="Image Unavailable due to poor internet Connection" width="700px" height="700px" />
                  </div>
